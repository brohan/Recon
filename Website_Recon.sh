...
sleep 2
firefox -new-tab http://www.peekyou.com/$fname"_"$lname &
firefox -new-tab http://www.addresses.com/people/$fname+$lname &
firefox -new-tab http://phonenumbers.addresses.com/people/$fname+$lname &
firefox -new-tab http://www.cvgadget.com/person/$fname/$lname &
firefox -new-tab http://pipl.com/search/?=$fname+$lname &
